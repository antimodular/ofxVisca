...
public:
    ...
    //https://laiatech.com/wp-content/uploads/2020/04/VISCA-commands.pdf
...
//    vector<int> brightnessSpecs = {10,0,10,4,-1};
    ...
    vector<unsigned char> brightnessUp = {0x80, 0x01, 0x04, 0x0e, 0x02, 0xFF};
     vector<unsigned char> brightnessOn = {0x80, 0x01, 0x04, 0x3e, 0x02, 0xFF};
     vector<unsigned char> brightnessOff = {0x80, 0x01, 0x04, 0x3e, 0x03, 0xFF};
    ...
    vector<int> satSpecs = {5,0,14,7,-1};
    vector<unsigned char> satDown = {0x80, 0x01, 0x04, 0x49, 0x00, 0x00, 0x00, 0x00, 0xFF}; //CAM_ColorGain
    vector<unsigned char> satUp = {0x80, 0x01, 0x04, 0x49, 0x00, 0x00, 0x00, 0x00, 0xFF};
    
     vector<int> contrastSpecs = {5,0,20,6,-1};
    vector<unsigned char> contrastDown = {0x80, 0x01, 0x04, 0x24, 0x76, 0x00, 0x00, 0xFF}; //CAM_RegisterValue
    vector<unsigned char> contrastUp = {0x80, 0x01, 0x04, 0x24, 0x76, 0x00, 0x00, 0xFF}; 
    
    vector<int> gammaSpecs = {7,0,21,4,-1};
    vector<unsigned char> gammaDown = {0x80, 0x01, 0x04, 0x5b, 0x00, 0xFF}; //CAM_Gamma
    vector<unsigned char> gammaUp = {0x80, 0x01, 0x04, 0x5b, 0x00, 0xFF};
 
    //-------video format
    vector<unsigned char> format720p50 = {0x80, 0x01, 0x04, 0x24, 0x72,  0x00,  0x0C, 0xFF}; // 
    vector<unsigned char> format720p60 = {0x80, 0x01, 0x04, 0x24, 0x72,  0x00,  0x0A, 0xFF}; //
    ...
    vector<unsigned char> formatUHDp30 = {0x80, 0x01, 0x04, 0x24, 0x72,  0x00,  0x1F, 0xFF}; // 3841 × 2160 30p
    ...
    vector<unsigned char> format4kp60 = {0x80, 0x01, 0x04, 0x24, 0x72,  0x00,  0x28, 0xFF}; // 4096 ×2160 60p
     ...
     vector<unsigned char> colorYUV = {0x80, 0x01, 0x04, 0x24, 0x60,  0x00,  0x00, 0xFF}; 
     vector<unsigned char> colorRGB = {0x80, 0x01, 0x04, 0x24, 0x60,  0x00,  0x01, 0xFF}; 
